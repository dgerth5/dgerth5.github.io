...
The result ends up with predictions that are on average, about 4.5 points different from the bookmaker spread. This is inline with predictions make by other contentestants in previous years, which gives me confidence that my predictions are not too far off of the market.  
