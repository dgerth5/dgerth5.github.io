...
$$
xPassPPA \sim \beta_0 + \beta_1 \text{ishome} + \beta_2 \text{isneutral} + OffTeam + DefTeam
$$
...
**Conclusion**  
Overall, while I’d be shocked if I finished near the top of the leaderboard at the end of the season, this was a fun project to work on, and I was able to learn a lot about time series modeling in Stan. Further improvements can be made to the priors and looking at returning production, or to the coefficient on the AR(1) terms to make them more time sensitive, but right now, I’m happy where the model is.  
